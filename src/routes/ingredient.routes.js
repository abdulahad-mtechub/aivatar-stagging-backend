 ...
 */
router.get("/", protect, ingredientController.getDailyIngredients);
 ...
 * @body    { mealIds: [1, 2, 3] }
 */
router.post("/add-to-grocery", protect, ingredientController.addToGrocery);
 ...
 */
router.get("/meal/:mealId", protect, ingredientController.getMealIngredients);
 ...
 */
router.post("/meal/:mealId", protect, ingredientController.addIngredient);
 ...
 */
router.post("/meal/:mealId/bulk", protect, ingredientController.bulkAddIngredients);

/**
 * @route   PATCH /api/ingredients/meal/:mealId/:ingredientId
 * @desc    Update a single ingredient
 */
router.patch("/meal/:mealId/:ingredientId", protect, ingredientController.updateIngredient);

/**
 * @route   DELETE /api/ingredients/meal/:mealId/:ingredientId
 * @desc    Delete a single ingredient
 */
router.delete("/meal/:mealId/:ingredientId", protect, ingredientController.deleteIngredient);

/**
 * @route   DELETE /api/ingredients/meal/:mealId
 * @desc    Delete ALL ingredients for a meal
 */
router.delete("/meal/:mealId", protect, ingredientController.deleteAllIngredients);
